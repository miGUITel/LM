...
* [1.1 Instalación](1INTRO/1.1instala.md)
* [1.2 Historia](1INTRO/1.2historia.md)
* [1.3 Características](1INTRO/1.3caract.md)
...
* [2.1 Variables](2CONCEPTOS/2.1variables.md)
* [2.2 Sintaxis](2CONCEPTOS/2.2sintaxis.md)
* [2.3 Código: primeros ejemplos](2CONCEPTOS/2.3code.md)
* [2.4 Dónde se usa JavaScript](2CONCEPTOS/2.4dondeSeUsa.md)
* [2.5 Tipos de datos](2CONCEPTOS/2.5tipos.md)
* [2.6 Dinámico](2CONCEPTOS/2.6dinamico.md)
* [2.7 Ejemplos de ejecución](2CONCEPTOS/2.7ejemplo.md)
...
* [Introducción a las funciones](3FUNCION/1_intro.md)
* [Funciones con parámetros y argumentos](3FUNCION/2_paramYargu.md)
* [Hoisting](3FUNCION/3_hoisting.md)
* [Funciones anónimas](3FUNCION/4_funcAnonimas.md)
* [Funciones auto-invocadas (IIFE)](3FUNCION/5_autoinvocadas.md)
...
## **5. JAVASCRIPT EN LA WEB**

* [Introducción](5WEB/1intro.md)
* [Interfaces de navegador / Web API](5WEB/2interfaces.md)
* [Pruebas en el navegador](5WEB/3pruebas.md)
* [Eventos (explicación)](5WEB/4eventos.md)
* [Ejercicio guiado](5WEB/ejercicio.html)

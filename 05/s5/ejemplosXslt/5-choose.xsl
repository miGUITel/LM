                ...
                <xsl:for-each select="concesionario/coches/coche">
                    ...
                    <xsl:choose>
                        <xsl:when test="combustible='Eléctrico'">
                            <h6>Este coche utiliza energía eléctrica.</h6>
                        </xsl:when>
                        <xsl:when test="combustible='Híbrido'">
                            <h6>Este coche combina combustible y energía eléctrica.</h6>
                        </xsl:when>
                        <xsl:when test="combustible='Diésel'">
                            <h6>Este coche utiliza diésel como combustible.</h6>
                        </xsl:when>
                        <xsl:otherwise>
                            <h6>Este coche utiliza gasolina u otro tipo de combustible.</h6>
                        </xsl:otherwise>
                    </xsl:choose>

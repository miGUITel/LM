...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <h1><xsl:value-of select="/concesionario/detalles/nombre" /></h1>
                
                <h3>Dirección: <xsl:value-of select="/concesionario/detalles/direccion" /></h3>
                <h3>Teléfono: <xsl:value-of select="/concesionario/detalles/telefono" /></h3>

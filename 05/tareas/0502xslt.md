...
* Inserta en un pdf ***una captura de pantalla del archivo XSL* y otra del resultado obtenido**.
...
**RNF2:** Para un **10**, entrega en html, con capturas y enlaces a los archivos xsl correspondientes.